...
| Ruby | v1.9.3 | v2.2.8, v2.3.5, v2.4.2, JRuby 9.1.14 |
| Sphinx | v2.1.2 | v2.1.9, v2.2.11 |
| ActiveRecord | v3.2 | v3.2, v4.0, v4.1, v4.2, v5.0, v5.1, v5.2 |

h3. Sphinx

Thinking Sphinx v3 is currently built for Sphinx 2.1 or newer, and releases since v3.1.0 expect Sphinx 2.1.2 or newer by default.
